...
export function ArtPage310({
  ...
  return (
    <section className={`art310-screen ${className ?? ""}`.trim()} aria-label="Pàgina 310 Art">
      <div className="art310-headline-wrap" style={headerStyle}>
      ...
      <div className="art310-grid">
        <div className="art310-left" style={leftStyle}>
        ...
        <div className="art310-right" style={rightStyle}>
